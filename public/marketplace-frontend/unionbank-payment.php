...
<div class="container ub">
    <div class="row">
        <div class="col-12 mx-auto">
            <img src="img/uborange.svg" class="ub-logo d-block mx-auto" alt="Logo">
        ...
        <div class="col-12 mx-auto">
            <a href="unionbank-confirm.php" class="btn btn-ub mt-4">CONFIRM</a>
            <p class="or text-center">or</p>
            <a href="marketplace.php" class="btn btn-ubreg">CANCEL</a>
        </div>
    </div>
</div>
